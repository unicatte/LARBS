...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/unicatte/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/unicatte/LARBS/master/progs.csv"
...
systembeepoff() { dialog --infobox "Getting rid of that [REDACTED] error beep sound..." 10 50
	rmmod pcspkr
...
# Make pacman and paru package lists verbose
